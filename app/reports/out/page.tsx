...
export default function Page() {
  ...
  const buildExportUrl = () => {
    const url = new URL('/api/reports/out', window.location.origin)
  ...
  const exportPdf = () => {
    const headers = ['ID Transaksi', 'Tanggal', 'Barang', 'Satuan', 'Teknisi', 'Keterangan', 'Jenis', 'Jumlah Keluar']
    ...
    openPrintWindow('Laporan Barang Keluar', headers, dataRows)
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Laporan Barang Keluar</h2>
          <p className="text-sm text-gray-500">Riwayat barang keluar</p>
        </div>
          ...
          <table className="min-w-full">
            <thead>
              <tr className="border-b border-gray-100 text-left text-xs font-semibold text-gray-500">
                ...
                <th className="py-3">Jumlah Keluar</th>
              </tr>
            </thead>
