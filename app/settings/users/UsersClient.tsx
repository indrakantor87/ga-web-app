      ...
      {(isNew || editing) && (
        <div className="rounded-xl border border-gray-200 bg-white p-4 sm:p-6 shadow-sm">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            />
            <input className="rounded-lg border p-2" placeholder="No HP" value={form.nohape} onChange={(e) => setForm({ ...form, nohape: e.target.value })} />
            <select className="rounded-lg border p-2" value={form.level} onChange={(e) => setForm({ ...form, level: e.target.value })}>
